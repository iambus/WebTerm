...
task 'watch', 'Compile source and watch', ->
	coffee ['-w', '-c', '.'],
		on_stdout: (s) ->
			console.log s.replace /^.*\.coffee:\d+:\d+: error:.*\n.*\r\n\s*\^+\x07$/m, (m) -> red m
		auto_recover: true
...
download_jquery_ui = ->
	zip = 'lib/jquery-ui-1.10.3.custom.zip'
...
download_depends = ->
	libs =
		...
		'http://layout.jquery-dev.net/lib/js/jquery.layout-latest.js': 'lib/jquery.layout-latest.js'
		'http://layout.jquery-dev.net/lib/js/jquery.layout-latest.min.js': 'lib/jquery.layout-latest.min.js'
		'http://layout.jquery-dev.net/lib/css/layout-default-latest.css': 'lib/layout-default-latest.css'
...
build_out = ->
	...
	files = [
		...
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/animated-overlay.gif'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_flat_0_aaaaaa_40x100.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_flat_75_ffffff_40x100.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_glass_55_fbf9ee_1x400.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_glass_65_ffffff_1x400.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_glass_75_dadada_1x400.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_glass_75_e6e6e6_1x400.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_glass_95_fef1ec_1x400.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-bg_highlight-soft_75_cccccc_1x100.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-icons_222222_256x240.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-icons_2e83ff_256x240.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-icons_454545_256x240.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-icons_888888_256x240.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/images/ui-icons_cd0a0a_256x240.png'
		'lib/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.min.css'
		'lib/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min.js'
		'lib/jquery.layout-latest.min.js'
		'lib/layout-default-latest.css'
		'lib/ace/ace.js'
